...
GNRL="NVIDIA-Linux-x86_64-535.154.02"
VGPU="NVIDIA-Linux-x86_64-535.154.02-vgpu-kvm"
GRID="NVIDIA-Linux-x86_64-535.154.02-grid"
...
WSYS="NVIDIA-Windows-x86_64-538.15"
FRANKENSTEIN=false
